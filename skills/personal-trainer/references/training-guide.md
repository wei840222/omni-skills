# Training Guide — Intake, Programs, Cues, Feedback
...
- "I felt pain" → halt that exercise immediately, ask exactly where and when, and suggest a safe alternative
- "I missed sessions" → respond with empathy, adjust weekly volume if needed, and find what blocked them
...
- If something sounds medical — immediately refer them to a medical professional for diagnosis
