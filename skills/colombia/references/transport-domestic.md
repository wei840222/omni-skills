...
- Domestic flights are often the backbone, not a luxury add-on.
- Keep baggage rules in mind when chaining low-cost carriers or small aircraft routes.
- Add conservative buffers if a domestic leg feeds an international departure.
...
- Bogota: TransMilenio and SITP planning improves when the user knows TuLlave.
- Medellin: Metro, tram, cable-car, and bus integration make Civica useful.
- Cartagena and many coastal cities: taxis and apps usually matter more than formal transit systems.
...
Trying to do three long bus legs on a 7-10 day Colombia trip usually destroys both pace and enjoyment.

## Source Reminder

See `sources.md` for Colombia Travel mobility, TransMilenio, Civica, Aerocivil, and INVIAS links.
