...
- access denied or blocked web session
- wrong or missing item
- unavailable item or substitution issue
- courier delay
- address mistake
- payment failure
...
- Cancellation: assume refund is safest only before merchant acceptance or dispatch; verify what the current order page allows.

## 4. Save the Durable Lesson

After resolution, store only the reusable part:
- merchant that frequently misses items
