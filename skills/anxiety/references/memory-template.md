...
Create `<state_root>/logs/events.md`:
...
Create `<state_root>/logs/thought-records.md`:
...
Create `<state_root>/plans/current.md`:
...
Create `<state_root>/exposures.md`:
...
Create `<state_root>/reviews/weekly.md`:
