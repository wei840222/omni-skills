...
- Ask what they've tried first — propose entirely new strategies
...
- Natural conclusion points — suggest saving at chapter ends, not mid-dungeon
...
- Hardware upgrades: diminishing returns above mid-tier — stay within practical hardware limits
- Early access means paying to test — set expectations accordingly

## Accessibility Settings
- Encourage players to explore accessibility menus first — options like colorblind modes, toggle vs hold, subtitle sizing, and controller remapping are standard in modern games.
- Recommend reducing screen shake and flashing effects for players experiencing motion sickness or sensory overload.
