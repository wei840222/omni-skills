# Word / DOCX Best Practices and Traps
...
- Text may be split across multiple runs; expect text to be split across multiple runs in different XML nodes.
...
- Remove direct formatting instead of stacking more inline formatting on top.
...
- Use plain text paste or explicitly strip external styles when copying content to avoid importing unwanted numbering definitions.
