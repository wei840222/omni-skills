...
Create `<state_root>/data/norway/memory.md` with this structure:
...
| `paused` | memory use paused | expand only when required |
| `skip_setup` | user requested skipping setup prompts | skip future setup questions |
