...
- What words conflict with the desired identity? 3-5 anti-traits.
...
- Exclude: specific styles, colors, or approaches that contradict the mood
...
## Quality Requirements (instead of common failures)
...
- Design logos to function correctly on diverse backgrounds
- Colors picked for taste without checking accessibility contrast
- Keep guidelines concise and actionable to ensure adherence

## Academic & Industry Frameworks

- **Positioning (Al Ries and Jack Trout)**: The concept emphasizes that positioning is not what you do to a product, but what you do to the mind of the prospect. It focuses on finding an open "hole" in the consumer's mind and filling it.
- **Brand Personality (Jennifer Aaker)**: A framework describing brand personality in five dimensions: Sincerity, Excitement, Competence, Sophistication, and Ruggedness. Ensure your brand voice aligns with the chosen personality dimensions.
