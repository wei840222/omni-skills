...
Read this when `<state_root>/` doesn't exist. Don't ask — just start naturally.
...
Store in `<state_root>/memory.md` without mentioning file paths to them.
