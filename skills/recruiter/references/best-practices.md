...
- Use inclusive language and essential requirements — filter out restrictive terms like "rockstar" to broaden applicant pools
...
- Treat resume gaps as conversation points — ask for context during the interview
...
- Limit interview loops to a maximum of 4-5 rounds to respect candidate time and signal a decisive culture
...
- Actively sell the role during the process — treat interviewing as a two-way evaluation
- Over-relying on credentials — pedigree doesn't guarantee performance

## Recruitment Metrics and DEI
- Time-to-fill (TTF) and Cost-per-hire (CPH) are standard efficiency metrics, but Quality-of-hire (QoH) is the ultimate indicator of success.
