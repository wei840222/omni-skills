...
```bash
mkdir -p <state_root>/digests
touch <state_root>/{memory.md,follow-ups.md,templates.md,vip-contacts.md}
...
Rely on separate mail integrations for access rather than requesting mailbox passwords or API secrets in this setup flow.
