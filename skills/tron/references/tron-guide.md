...
- Keep your private key strictly confidential — standard security applies

## Transaction Characteristics
- Block time ~3 seconds — fast finality
- Transactions are free if bandwidth available — major advantage
- Resources are preserved if a transaction fails — unlike Ethereum gas
...
## Security
- Private keys control everything — ensure they remain strictly confidential
