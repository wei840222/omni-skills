...
| Blockhash not found or expired transaction | Check the current signature status before retrying. | Fetch a fresh blockhash, then rebuild, re-sign, and resubmit the transaction; the new signature binds the replacement blockhash. |
