...
When `<state_root>/` doesn't exist, explain what the skill does and ask for permission to create it.

## Transparency First

This skill needs to:
1. Create `<state_root>/` to store rules and validators
...
Explain you'll create `<state_root>/`:
